...
| Load sharing between chargers (Labs preview, UI ahead of firmware) | — (pending firmware support) | `/settings/loadsharing` (gated on Labs) | `loadsharing_*` | `/loadsharing/status`, `/loadsharing/peers`, `/loadsharing/discover` | — | [load-shaper.md](../user/load-shaper.md) |
