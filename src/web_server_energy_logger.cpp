...
// When ENABLE_TSDB is set, the time-series logger (web_server_energy_tsdb.cpp)
// provides the /energy/* handlers instead; compile this legacy logger out so the
// handlers aren't multiply defined and we don't reference the absent energyLogger.
#ifndef ENABLE_TSDB
