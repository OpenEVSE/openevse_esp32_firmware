...
// Divert settings
  ...
  new ConfigOptDefenition<int32_t>(divert_reserve_power_w, 200, "divert_reserve_power", "drp"),
  new ConfigOptDefenition<int32_t>(divert_hysteresis_power_w, 600, "divert_hysteresis_power", "dhp"),
